...
<div id="error_content">
	<h2>
		<img 
			...
			width="227" 
			alt="페이지를 찾을 수 없습니다" 
			src="http://static.naver.com/common/error/h2_notfound_s.gif"
		>
	</h2>
	<div class="content">
		<p>죄송합니다. 유효하지 않은 요청입니다.<br>접근하고자하는 블로그 아이디가 없습니다.  접근하고자하는 블로그 아이디를 입력해주시기 바랍니다.</p>
	</div>
	<p class="btn"><a href="javascript:history.back(-1)"><img height="23" width="82" alt="이전 페이지" src="http://static.naver.com/common/error/btn_goback.gif"></a>
	<a href="${pageContext.request.contextPath}" target="_top"><img height="23" width="79" alt="블로그 홈" src="http://static.naver.com/common/error/btn_bloghome.gif"></a></p>
</div>
</body>
</html>